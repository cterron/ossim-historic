...
if ($ARGV[0] eq "clear") {
	...
	@querys = ("TRUNCATE acid_event","TRUNCATE device","TRUNCATE extra_data","TRUNCATE reputation_data","TRUNCATE idm_data","TRUNCATE ac_acid_event","TRUNCATE ah_acid_event");
	foreach	$q (@querys) {
		print "$q\n";
