...
UPDATE dashboard_widget_config SET title = 'SIEM vs Logger Events' WHERE type_id = 1001 AND title = 'Latest SIEM vs Logger Events';

ALTER TABLE vuln_nessus_report_stats MODIFY COLUMN name VARCHAR(64) NOT NULL DEFAULT '';

ALTER TABLE incident_ticket MODIFY COLUMN id int(11) NOT NULL AUTO_INCREMENT;
