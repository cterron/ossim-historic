...
<div id="updates" style="position:absolute;top:16px;left:240px;z-index:1000;background:url(pixmaps/ballooninfo.png) no-repeat;width:190px;height:57px;padding:8px 0px 0px 7px;">
<?php
    $link = "updates/index.php?hmenu=Upgrade&smenu=Updates";
    if ($check_updates == "") echo "<a href='$link' class='blue' target='main'>" . _("Enable auto update checks") . "?</a>";
    elseif ($new_updates) echo "<img src='pixmaps/top/lamp.png' align='absmiddle' border=0>&nbsp;<a href='$link' class='blue' target='main'> New updates available</a>";
?>
</div>
<?php
} ?>
