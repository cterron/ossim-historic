...
{
    $output_name = _("Hosts_from_group_$group_id") .'__' . gmdate('Y-m-d', time()) . '.csv';
        ...
        function get_csv_data()
        {
            $.ajax(
            {
                ...
                success: function(html)
                {
                    ...
                    setTimeout('document.location.href = "/ossim/asset_details/index.php?id=<?php echo $group_id?>"', 1000);
                }
            });
        }
...
<body>
    <div id='container'>
        <div id='loading'>
            <div>
                <img src='../pixmaps/loading3.gif' alt='<?php echo _('Exporting hosts from group to CSV')?>'/>
                <span><?php echo _('Exporting hosts from group to CSV')?>.</span>
