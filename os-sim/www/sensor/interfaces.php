...
?>
    <p> <?php
    echo gettext("Interface succesfully"); ?> <?php
    echo $temp_msg; ?></p>
    <p><a href="sensor.php"> <?php
...
<table align="center">
<tr><th> <?php
    echo gettext("Interface"); ?> </th><th> 
<?php
    echo gettext("Name"); ?> </th><th> 
<?php
    echo gettext("Main"); ?> </th><th> 
<?php
    echo gettext("Action"); ?> </th></tr>
<?php
...
<input type="hidden" name="sensor" value="<?php
        echo $sensor; ?>">
<input type="hidden" name="interface" value="<?php
        echo $s_int->get_interface(); ?>">
<tr>
<td><?php
        echo $s_int->get_interface(); ?></td>
<td><input type="text" name="name" value="<?php
        echo $s_int->get_name(); ?>"></td>
<td><select name="main">
<?php
        if ($s_int->get_main()) {
?>
...
<td>
	<input type="submit" name="submit" value="Update" class="btn" style="font-size:12px">
	<input type="submit" name="submit" value="Delete" class="btn" style="font-size:12px"></td>
</tr>
</form>
<?php
    }
...
<td><input type="submit" name="submit" value="Insert" class="btn" style="font-size:12px"></td>
</tr>
</table>
<?php
} else {
