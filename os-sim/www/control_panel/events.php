...
?>
        ...
        <td bgcolor="#eeeeee" nowrap>
            <?php
        echo "<a href=\"$src_link\" onMouseOver=\"showhint('$src_title', this, event, '200px')\" target=\"_blank\">$src_name</a>:$src_port $src_img"; ?></td>
        <td bgcolor="#eeeeee" nowrap>
            <?php
        echo "<a href=\"$dst_link\" onMouseOver=\"showhint('$dst_title', this, event, '200px')\" target=\"_blank\">$dst_name</a>:$dst_port $dst_img"; ?></td>
        <!-- src & dst hosts -->
