...
<td> <?php
        echo round(($event->get_count()) / $perl_interval); ?>h. </td>
...
<A HREF="<?php
        ...
        echo $ip; ?>">
<?php
        echo Host::ip2hostname($conn, $ip); ?></A></th><td> <?php
        echo $event->get_what(); ?></td>
<td> <?php
        echo $event->get_anomaly_time(); ?></td>
<td> <?php
...
<A HREF="<?php
        ...
        echo $anom_os["ip"]; ?>">
<?php
        echo Host::ip2hostname($conn, $anom_os["ip"]); ?></A>
</td>
<td colspan="1"><?php
...
<A HREF="<?php
        ...
        echo $anom_mac["ip"]; ?>">
<?php
        echo Host::ip2hostname($conn, $anom_mac["ip"]); ?></A>
</td>
<td colspan="1"><?php
...
<?php
        echo Host::ip2hostname($conn, $anom_services["ip"]); ?></A>
</td>
<td colspan="1"><?php
