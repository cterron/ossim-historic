...
<body>
  ...
  <h1> <?php echo gettext("OSSIM Framework - services list"); ?> </h1>
...
<?php 
if ($show_anom) 
    echo "<a href=\"services.php\">".gettext("Showing only anomalies, click here to see the complete services list")."</a>";
else 
