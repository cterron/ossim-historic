...
{
	if ( !Token::verify('tk_form_pg', POST('token')) )
	{
...
if ( POST('insert') && empty($data['data']['id']) )
{
	...
	<script type='text/javascript'>
        ...
        {
            document.location.href="newportgroupform.php?id=<?php echo $id?>&update=1";
        }      
    </script>
	<?php
}
...
{	
    ...
    <script type='text/javascript'>
        ...
        {
            document.location.href="portgroup.php?msg=unknown_error";
        }  
    </script>
    <?php
} 
