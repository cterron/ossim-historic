    ...
    */
    ...
    foreach($sources as $source) {
        ...
        foreach($dests as $dest) {
            ...
            /*
            $debug = array($id, $priority, $begin_hour, $end_hour,
            $begin_day, $end_day, $descr,
            $source_ips, $source_host_groups, $dest_ips, $dest_host_groups,
            $source_nets, $source_net_groups, $dest_nets, $dest_net_groups,
            ...
            */
            ...
            if (count($responses) > 0) Response::insert($conn, "policy $id", $source_nets, $source_ips, $dest_nets, $dest_ips, $sensors, $ports, $ports, $plug_ids, $responses);
?>
    <p> <?php
            echo gettext("Policy succesfully updated"); ?> </p>
