...
echo "var labels  = new Array();
	labels['error_found']      = '"._("We found the following errors").":';
	...
	labels['delete_msg']       = '".Util::js_entities(_("This action will remove the system, related sensor, server and assets, and disable all related policies. Are you sure you want to remove this system?")).".';
	...
	labels['unknown_error']    = '"._("Sorry, operation was not completed due to an unknown error")."';
	";
