...
?>
    ...
    if (!Host::in_host($conn, $ip)) {
        Host::insert($conn, $ip, $hostname, $asset, $threshold_c, $threshold_a, $rrd_profile, $alert, $persistence, $nat, $sensors, $descr, $os, $mac, $mac_vendor);
    } else {
        Host::update($conn, $ip, $hostname, $asset, $threshold_c, $threshold_a, $rrd_profile, $alert, $persistence, $nat, $sensors, $descr, $os, $mac, $mac_vendor);
    }
...
?>
    <p> <?php
echo gettext("Host succesfully inserted"); ?> </p>
