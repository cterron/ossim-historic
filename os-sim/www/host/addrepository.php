...
<body style="margin:0">
<table width="100%">
	<tr><th>RELATIONSHIPS for host: <?php echo $id_host ?></th></tr>
	<?php
if (count($rel_list) > 0) { ?>
	<tr>
		<td>
...
?>
				<tr>
					...
					<td class="nobborder"><a href="<?php echo $_SERVER['PHP_SELF'] ?>?id_host=<?php echo $id_host ?>&name_host=<?php echo $name_host ?>&key_delete=<?php echo $id_host ?>&id_delete=<?php echo $rel['id_document'] ?>"><img src="../repository/images/del.gif" border="0"></a></td>
				</tr>
				<?php
    } ?>
			</table>
...
?>
					...
					<td><input type="button" value="Link" onclick="document.flinks.insert.value='1';document.flinks.submit();"></td>
				</tr>
			</table>
		</td>
	</tr>
</form>
	<tr><td align="center"><input type="button" onclick="parent.document.location.href='host.php'" value="Finish"></td></tr>
</table>
</body>
</html>
<?php
