...
$xml = "";
$host_group_list = Host_group::get_list($conn, "ORDER BY $order $limit");
...
foreach($host_group_list as $host_group) {
    ...
    $rep = "";
    if ($linkedocs = Repository::have_linked_documents($conn, $host_group->get_name() , 'host_group')) $rep.= "<a href=\"../repository/repository_list.php?keyname=" . urlencode($name) . "&type=host_group\" target=\"addcontent\" class=\"blue\">[" . $linkedocs . "]</a>&nbsp;";
