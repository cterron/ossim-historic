...
<body>
  ...
  <h1> <?php echo gettext("Insert new host group"); ?> </h1>
...
<form method="post" action="newhostgroup.php">
<table align="center">
  ...
  <tr>
    <th> <?php echo gettext("Hosts"); ?> <br/>
	  ...
	  <?php echo gettext("Insert new host"); ?> ?</a>
        </font>
    </th>
    <td class="left">
<?php
...
?>
        <input type="checkbox" name="<?php echo $name;?>"
            value="<?php echo $host_ip; ?>">
            <?php echo $host_name . " (" . $host_ip . ")<br>";?>
        </input>
<?php
            $i++;
        }
