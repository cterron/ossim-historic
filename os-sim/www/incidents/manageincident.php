...
if ($action == 'newticket') {
    ...
    if (ossim_error()) {
        die_error(null, "<br/><a href=\"incident.php?id=$id\">" . _("Continue") . '</a>');
    }
    header("Location: incident.php?id=$id");
    exit;
}
...
if ($action == 'newincident') {
    ...
    if (GET('ref') == 'Alarm' or GET('ref') == 'Event') {
        ...
        $incident_id = Incident::$method($conn, $title, $type, $submitter, $priority, $src_ips, $dst_ips, $src_ports, $dst_ports, $event_start, $event_end);
    }
