...
echo gettext("Low"); ?>
          ...
          <td nowrap style="border-width: 0px;">
            <input type="submit" name="filter" value="OK" class="btn" style="font-size:12px"/>
          </td>
        </tr>
      </tr>
      </table>
...
?>
    <tr><td colspan="7" style="border-width: 0px;">
      <table width="100%" align="center" style="border-width: 0px;">
      <tr>
          <td><?php echo _("with User") ?></td>
          <td><?php echo _("with Title") ?></td>
          <td><?php echo _("with Attachment Name") ?></td>
          <td><?php echo _("with Tag") ?></td>
      </tr><tr>
          <td style="border-width: 0px;">
