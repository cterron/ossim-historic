	...
	<div id='c_incident'>
    	...
    	<form name='f_incident' id='f_incident' method="POST" action="<?php echo $form_url?>" enctype="multipart/form-data">
    		...
    		<table id='t_incident' align="center">
    			...
    			//Help legends
    			$ips_legend  = _('You can type one unique IP Address or a IP list separated by coma: IP1, IP2, IP3...');
    			$date_legend = _('The datetime format allowed is').': YYYY-MM-DD HH:MM:SS';
