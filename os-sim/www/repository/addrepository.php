...
if ($id_link == "" || $name_link == "" || $type_link == "") exit;
// DB connect
...
if (GET('linkdoc') != "" && GET('insert') == "1") {
    ...
    Repository::insert_relationships($conn, GET('linkdoc') , $name_link, $type_link, $id_link);
}
...
?>
				<tr>
					...
					<td class="nobborder"><a href="<?php echo $_SERVER['PHP_SELF'] ?>?id=<?php echo $id ?>&id_link=<?php echo $id_link ?>&name_link=<?php echo $name_link ?>&key_delete=<?php echo $id_link ?>&id_delete=<?php echo $rel['id_document'] ?>&type_link=<?php echo $type_link ?>"><img src="../repository/images/del.gif" border="0"></a></td>
				</tr>
				<?php
    } ?>
			</table>
