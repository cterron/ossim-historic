...
<table cellpadding=0 cellspacing=2 border=0 width="100%">
	...
	<tr>
		<td class="center">Document successfully updated with id: <?php echo $id_document ?></td>
	</tr>
			...
			<table cellpadding=0 cellspacing=2 border=0 class="noborder">
				...
				<tr>
					<td class="nobborder" style="padding-left:5px">
						<textarea id="textarea" name="doctext" rows="4" style="width:460px"><?php echo $document['text'] ?></textarea>
					</td>
				</tr>
