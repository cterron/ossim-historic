	...
	function action(com,grid) {
		...
		if (com=='Delete selected') {
			...
			if (typeof(items[0]) != 'undefined') {
				$("#flextable").changeStatus('Deleting action...',false);
				$.ajax({
						type: "GET",
...
?>
		...
		buttons : [
			{name: 'Insert new action', bclass: 'add', onpress : action},
			{separator: true},
...
?>",
		usepager: true,
		title: 'Actions',
		pagestat: 'Displaying {from} to {to} of {total} Actions',
		nomsg: 'No Actions',
		useRp: true,
		rp: 25,
