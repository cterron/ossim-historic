...
?>
      <table width="100%">
        ...
        echo gettext("Click here to view or hide this type of directives"); ?>"
                 alt="Click here to view or hide this type of directives."
                 style="cursor:pointer"/>
            <?php
...
?>				
            ...
            echo $directive->get_attribute('id'); ?>','right'); }" style="marging-left:20px; cursor:pointer" TITLE="<?php
            ...
            echo $dir_id; ?>" target="right" TITLE="<?php
