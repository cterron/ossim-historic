                    ...
                    $('.table_data tbody tr').on('click', function ()
                    {
                        ...
                        if(n_clicks === 1)
                        {
                            ...
                            click_timer = setTimeout(function()
                            {
                                ...
                                GB_show('<?php echo Util::js_entities(_('Message Detail'))?>','detail.php?id=' + $(row).attr('id') + '&date=' + encodeURIComponent(ctime), 600, '900');
...
<body>
    ...
    <div style='width:100%'>
        ...
        <div>
            ...
            <div class="level">
                <form>
                    <label for="level" class='l_label'><?php echo _('Filter By')?>:</label>
                    <select name="level" onchange="this.form.submit()">
                        <option value="1" <?php if ($level == 1) echo 'selected="selected"'?>><?php echo _('Info, Warning & Errors')?></option>
                        <option value="2" <?php if ($level == 2) echo 'selected="selected"'?>><?php echo _('Warning & Errors')?></option>
                        <option value="3" <?php if ($level == 3) echo 'selected="selected"'?>><?php echo _('Errors')?></option>
                    </select>
                </form>
            </div>
