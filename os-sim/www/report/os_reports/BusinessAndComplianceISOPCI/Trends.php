            ...
            <tr>
                <td valign="top" class="nobborder">
                    <table width="100%" class="nobborder">
                        ...
                        <tr>
                              <td style="text-align:center" valign="top" class="nobborder"><img src="'.$htmlPdfReport->newImage('/report/os_reports/BusinessAndComplianceISOPCI/TrendsLine2.php?sess=1&year='.$year,'png').'" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                <td valign="top" class="nobborder">
                    <table width="100%" class="nobborder">
                        ...
                        <tr>
                            <td style="text-align:center" valign="top" class="nobborder"><img src="'.$htmlPdfReport->newImage('/report/os_reports/BusinessAndComplianceISOPCI/TrendsLine3.php?sess=1&year='.$year,'png').'" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                <td valign="top" class="nobborder">
                    <table width="100%" class="nobborder">
                        ...
                        <tr>
                            <td style="text-align:center" valign="top" class="nobborder"><img src="'.$htmlPdfReport->newImage('/report/os_reports/BusinessAndComplianceISOPCI/TrendsLine4.php?sess=1&year='.$year,'png').'" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
