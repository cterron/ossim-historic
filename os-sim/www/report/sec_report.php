...
<?php
    $list = $security_report->AttackHost($security_report->ossim_conn, $target, $NUM_HOSTS, $report_type);
    foreach($list as $l) {
        $ip = $l[0];
...
?>
    ...
    if ($report_type == "alarm") { ?>
        <h2>Top <?php
        echo "$NUM_HOSTS Alarms" ?></h2>
        <?php
    } else { ?>
        <h2>Top <?php
        echo "$NUM_HOSTS Events" ?></h2>
        <?php
    } ?>
        <table align="center">
          <tr>
...
?>
        ...
        echo $NUM_HOSTS
?>&type=<?php
        echo $report_type ?>" alt="events graph"/>
<?php
    }
?>
          </td>
...
?>
    ...
    if ($report_type == "alarm") { ?>
        <h2>Top <?php
        echo "$NUM_HOSTS Alarms by Risk" ?></h2>
        <?php
    } else { ?>
        <h2>Top <?php
        echo "$NUM_HOSTS Events by Risk" ?></h2>
        <?php
    } ?>
...
?>
        <h2>Top <?php
        echo "$NUM_HOSTS" ?> less stabe services</h2>
        <table align="center">
          <tr>
            <th> <?php
