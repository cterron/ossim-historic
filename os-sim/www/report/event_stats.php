...
<a href="<?php echo $acid_link . $acid_prefix . "_qry_main.php?new=1&layer4=TCP&num_result_rows=-1&sort_order=time_d&submit=Query+DB&clear_allcriteria=1&clear_criteria=time" ?>">
<img src="<?php echo stat_image("tcp_events", $curr_rng); ?>" border="0">
</a>
<a href="<?php echo $acid_link . $acid_prefix . "_qry_main.php?new=1&layer4=UDP&num_result_rows=-1&sort_order=time_d&submit=Query+DB&clear_allcriteria=1&clear_criteria=time" ?>">
<img src="<?php echo stat_image("udp_events", $curr_rng); ?>" border="0">
</a>
<a href="<?php echo $acid_link . $acid_prefix . "_qry_main.php?new=1&layer4=ICMP&num_result_rows=-1&sort_order=time_d&submit=Query+DB&clear_allcriteria=1&clear_criteria=time" ?>">
<img src="<?php echo stat_image("icmp_events", $curr_rng); ?>" border="0">
</a>
<a href="<?php echo $acid_link . $acid_prefix . "_qry_main.php?new=1&layer4=RawIP&num_result_rows=-1&sort_order=time_d&submit=Query+DB&clear_allcriteria=1&clear_criteria=time" ?>">
