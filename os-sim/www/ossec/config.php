...
<head>
	...
	<script type="text/javascript" src="/ossim/js/ui.multiselect.js"></script>
			...
			<tr>
				<td id='oss_mcontainer'>
					<ul class='oss_tabs'>
						...
						<li id='litem_tab3'><a href="#tab3" id='link_tab3'><?php echo ucfirst(basename(Ossec::CONF_PATH))?></a></li>
					</ul>
				</td>
			</tr>
		</table>
