...
$_POST['agent_ip']   = $agent_data[0];
$_POST['agent_name'] = $agent_data[1];
                ...
                <tr>
                    <td class="nobborder" valign="top">
                        <form id='form_a_deployment' name='form_a_deployment' method="POST">
                            ...
                            <input type="hidden" name="agent_name" id="agent_name" class='vfield' value="<?php echo $agent_name?>"/>
                            ...
                            <table id='table_container'>
                                ...
                                <tr>
                                    ...
                                    <td class="left">
                                        <input type="text" class='dis_input' disabled='disabled' readonly='readonly' name="agent_ip_txt" id="agent_ip_txt" value="<?php echo $agent;?>"/>
                                    </td>
                                </tr>
