...
echo "var ossec_msg = new Array();
		  ...
		  ossec_msg['unknown_error']        = '"._("Sorry, operation was not completed due to an error when processing the request")."';
		  ...
		  ossec_msg['error_header']         = '"._("The following errors occurred:")."';
