...
DEFINE('_MONTH', 'Month');
DEFINE('_YEAR', 'Year');
DEFINE('_ALERTGROUP', 'Event Group');
DEFINE('_ALERTTIME', 'Event Time');
...
DEFINE('_MOSTFREQALERTS', 'Most Frequent Events');
DEFINE('_MOSTFREQPORTS', 'Most Frequent Ports');
DEFINE('_MOSTFREQADDRS', 'Most Frequent IP addresses');
DEFINE('_LASTALERTS', 'Last Events');
DEFINE('_LASTPORTS', 'Last Ports');
DEFINE('_LASTTCP', 'Last TCP Events');
DEFINE('_LASTUDP', 'Last UDP Events');
DEFINE('_LASTICMP', 'Last ICMP Events');
...
DEFINE('_AGMAINT', 'Event Group Maintenance');
DEFINE('_USERPREF', 'User Preferences');
DEFINE('_CACHE', 'Cache & Status');
DEFINE('_ADMIN', 'Administration');
DEFINE('_GALERTD', 'Graph Event Data');
DEFINE('_GALERTDT', 'Graph Event Detection Time');
...
DEFINE('_ALERTS', ' Events:');
DEFINE('_ADDRESSES', ' Addresses');
DEFINE('_ANYPROTO', 'any protocol');
DEFINE('_UNI', 'unique');
DEFINE('_LISTING', 'listing');
DEFINE('_TALERTS', 'Today\'s event: ');
DEFINE('_SOURCEIP', 'Source IP');
DEFINE('_DESTIP', 'Destination IP');
DEFINE('_L24ALERTS', 'Last 24 Hours events: ');
DEFINE('_L72ALERTS', 'Last 72 Hours events: ');
DEFINE('_UNIALERTS', ' Unique Events');
...
DEFINE('_NOALERTSDETECT', 'no events detected');
DEFINE('_USEALERTDB', 'Use Event Database');
...
//base_action.inc.php
DEFINE('_NOACTION', 'No action was specified on the events');
DEFINE('_INVALIDACT', ' is an invalid action');
DEFINE('_ERRNOAG', 'Could not add events since no AG was specified');
DEFINE('_ERRNOEMAIL', 'Could not email events since no email address was specified');
...
DEFINE('_DELETEALERT', 'Delete event(s)');
DEFINE('_EMAILALERTSFULL', 'Email event(s) (full)');
DEFINE('_EMAILALERTSSUMM', 'Email event(s) (summary)');
DEFINE('_EMAILALERTSCSV', 'Email event(s) (csv)');
DEFINE('_ARCHIVEALERTSCOPY', 'Archive event(s) (copy)');
DEFINE('_ARCHIVEALERTSMOVE', 'Archive event(s) (move)');
DEFINE('_IGNORED', 'Ignored ');
DEFINE('_DUPALERTS', ' duplicate event(s)');
DEFINE('_ALERTSPARA', ' eventt(s)');
DEFINE('_NOALERTSSELECT', 'No events were selected or the');
...
DEFINE('_ERRNOEMAILEXP', 'EXPORT ERROR: Could not send exported events to');
DEFINE('_ERRNOEMAILPHP', 'Check the mail configuration in PHP.');
DEFINE('_ERRDELALERT', 'Error Deleting Event');
...
DEFINE('_ALERTSCACHE', ' Event(s) to the Event cache');
//base_db.inc.php
...
DEFINE('_DISPANYAG', '{ any Event Group }');
...
DEFINE('_DISPLAYINGTOTAL', 'Displaying events %d-%d of %d total');
DEFINE('_NOALERTS', 'No Events were found.');
...
//base_ag_main.php
DEFINE('_AGMAINTTITLE', 'Event Group (AG) Maintenance');
...
DEFINE('_NOALERTGOUPS', 'There are no Event Groups');
DEFINE('_NUMALERTS', '# Events');
...
DEFINE('_GRAPHALERTS', 'Graph Events');
DEFINE('_AXISCONTROLS', 'X / Y AXIS CONTROLS');
DEFINE('_CHRTTYPEHOUR', 'Time (hour) vs. Number of Events');
DEFINE('_CHRTTYPEDAY', 'Time (day) vs. Number of Events');
DEFINE('_CHRTTYPEWEEK', 'Time (week) vs. Number of Events');
DEFINE('_CHRTTYPEMONTH', 'Time (month) vs. Number of Events');
DEFINE('_CHRTTYPEYEAR', 'Time (year) vs. Number of Events');
DEFINE('_CHRTTYPESRCIP', 'Src. IP address vs. Number of Events');
DEFINE('_CHRTTYPEDSTIP', 'Dst. IP address vs. Number of Events');
DEFINE('_CHRTTYPEDSTUDP', 'Dst. UDP Port vs. Number of Events');
DEFINE('_CHRTTYPESRCUDP', 'Src. UDP Port vs. Number of Events');
DEFINE('_CHRTTYPEDSTPORT', 'Dst. TCP Port vs. Number of Events');
DEFINE('_CHRTTYPESRCPORT', 'Src. TCP Port vs. Number of Events');
DEFINE('_CHRTTYPESIG', 'Sig. Classification vs. Number of Events');
DEFINE('_CHRTTYPESENSOR', 'Sensor vs. Number of Events');
...
DEFINE('_ERRNOAGSPEC', 'No AG was specified.  Using all events.');
DEFINE('_CHRTDATAIMPORT', 'Starting data import');
DEFINE('_CHRTTIMEVNUMBER', 'Time vs. Number of Events');
DEFINE('_CHRTTIME', 'Time');
DEFINE('_CHRTALERTOCCUR', 'Event Occurrences');
DEFINE('_CHRTSIPNUMBER', 'Source IP vs. Number of Events');
DEFINE('_CHRTSIP', 'Source IP Address');
DEFINE('_CHRTDIPALERTS', 'Destination IP vs. Number of Events');
DEFINE('_CHRTDIP', 'Destination IP Address');
DEFINE('_CHRTUDPPORTNUMBER', 'UDP Port (Destination) vs. Number of Events');
DEFINE('_CHRTDUDPPORT', 'Dst. UDP Port');
DEFINE('_CHRTSUDPPORTNUMBER', 'UDP Port (Source) vs. Number of Events');
DEFINE('_CHRTSUDPPORT', 'Src. UDP Port');
DEFINE('_CHRTPORTDESTNUMBER', 'TCP Port (Destination) vs. Number of Events');
DEFINE('_CHRTPORTDEST', 'Dst. TCP Port');
DEFINE('_CHRTPORTSRCNUMBER', 'TCP Port (Source) vs. Number of Events');
DEFINE('_CHRTPORTSRC', 'Src. TCP Port');
DEFINE('_CHRTSIGNUMBER', 'Signature Classification vs. Number of Events');
DEFINE('_CHRTCLASS', 'Classification');
DEFINE('_CHRTSENSORNUMBER', 'Sensor vs. Number of Events');
...
DEFINE('_GRAPHALERTDATA', 'Graph Event Data');
...
DEFINE('_MNTAIC', 'Event Information Cache:');
...
DEFINE('_QAALERTDELET', 'Event DELETED');
...
DEFINE('_QSCOFALERTS', 'of events');
//base_stat_alerts.php
DEFINE('_ALERTTITLE', 'Event Listing');
//base_stat_common.php
DEFINE('_SCCATEGORIES', 'Categories:');
DEFINE('_SCSENSORTOTAL', 'Sensors/Total:');
DEFINE('_SCTOTALNUMALERTS', 'Total Number of Events:');
...
DEFINE('_PSUNIALERTS', 'Unique Events');
...
DEFINE('_PSDETECTAMONG', '%d unique events detected among %d events on %s');
DEFINE('_PSALLALERTSAS', 'all events with %s/%s as');
DEFINE('_PSSHOW', 'show');
...
//base_stat_time.php
DEFINE('_BSTTITLE', 'Time Profile of Events');
...
DEFINE('_PROFILEALERT', 'Profile Event');
//base_stat_uaddr.php
...
DEFINE('_SUAUNIALERTS', 'Unique&nbsp;Events');
