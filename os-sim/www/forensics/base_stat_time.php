...
function PrintTimeProfile($time) {
    ...
    echo '<TR><TD CLASS="plfieldhdr">&nbsp;</TD>
              <TD CLASS="plfieldhdr">' . $total . '</TD>
              <TD CLASS="plfieldhdr">&nbsp;</TD></TR>
          </TABLE>';
}
// TIME PROFILE
...
echo '<FORM ACTION="base_stat_time.php" METHOD="get" style="margin-top:3px">
		...
		<TABLE WIDTH="100%" BORDER=0 cellpadding=0 cellspacing=0>
         <TR>
          <TD WIDTH="100%" CLASS="metatitle"><B><FONT COLOR="#FFFFFF">' . _BSTTIMECRIT . '</FONT></B></TD>
          <TD></TD></TR>
        </TABLE>';
$today_d = date("d");
$today_m = date("m");
...
<tr>
	<td align="center">
		<table cellpadding=5>
			<tr>
				<!--<td bgcolor="<?php
echo ($_GET['time_option'] == "ht") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=ht&time_range=today&time_sep[0]=hour&time_sep[1]=on&time[0][0]=<?php echo $today_m ?>&time[0][1]=<?php echo $today_d ?>&time[0][2]=<?php echo $today_y ?>&time[1][0]=<?php echo $today_m ?>&time[1][1]=<?php echo $today_d ?>&time[1][2]=<?php echo $today_y ?>&submit=submit">Today</a></td>-->
				<td bgcolor="<?php
echo ($_GET['time_option'] == "ht") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=ht&time_range=today&time_sep[0]=hour&time_sep[1]=on&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $today_m ?>&time[0][3]=<?php echo $today_d ?>&time[0][4]=<?php echo $today_y ?>&time[1][0]=&time[1][1]=&time[1][2]=&submit=submit&time_cnt=1">Today</a></td>
				<!--<td bgcolor="<?php
echo ($_GET['time_option'] == "hy") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=hy&time_range=day&time_sep[0]=hour&time_sep[1]=on&time[0][0]=<?php echo $yesterday_m ?>&time[0][1]=<?php echo $yesterday_d ?>&time[0][2]=<?php echo $yesterday_y ?>&time[1][0]=<?php echo $today_m ?>&time[1][1]=<?php echo $today_d ?>&time[1][2]=<?php echo $today_y ?>&submit=submit">Yesterday</a></td>-->
				<td bgcolor="<?php
echo ($_GET['time_option'] == "hy") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=hy&time_range=day&time_sep[0]=hour&time_sep[1]=on&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $yesterday_m ?>&time[0][3]=<?php echo $yesterday_d ?>&time[0][4]=<?php echo $yesterday_y ?>&time[1][0]=&time[1][1]=%3C%3D&time[1][2]=<?php echo $today_m ?>&time[1][3]=<?php echo $today_d ?>&time[1][4]=<?php echo $today_y ?>&submit=submit&time_cnt=1">Yesterday</a></td>
				<!--<td bgcolor="<?php
echo ($_GET['time_option'] == "hw") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=hw&time_range=week&time_sep[0]=hour&time_sep[1]=between&time[0][0]=<?php echo $week_m ?>&time[0][1]=<?php echo $week_d ?>&time[0][2]=<?php echo $week_y ?>&time[1][0]=<?php echo $today_m ?>&time[1][1]=<?php echo $today_d ?>&time[1][2]=<?php echo $today_y ?>&submit=submit">This Week</a></td>-->
				<td bgcolor="<?php
echo ($_GET['time_option'] == "hw") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=hw&time_range=week&time_sep[0]=hour&time_sep[1]=between&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $week_m ?>&time[0][3]=<?php echo $week_d ?>&time[0][4]=<?php echo $week_y ?>&time[1][0]=&time[1][1]=%3C%3D&time[1][2]=<?php echo $today_m ?>&time[1][3]=<?php echo $today_d ?>&time[1][4]=<?php echo $today_y ?>&submit=submit&time_cnt=1">This Week</a></td>
				<!--<td bgcolor="<?php
echo ($_GET['time_option'] == "hw2") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=hw2&time_range=weeks&time_sep[0]=hour&time_sep[1]=between&time%5B0%5D%5B0%5D=<?php echo $two_week_m; ?>&time%5B0%5D%5B1%5D=<?php echo $two_week_d ?>&time%5B0%5D%5B2%5D=<?php echo $two_week_y ?>&time%5B1%5D%5B0%5D=<?php echo $today_m ?>&time%5B1%5D%5B1%5D=<?php echo $today_d ?>&time%5B1%5D%5B2%5D=<?php echo $today_y ?>&submit=submit">Last two Weeks</a></td>-->
				<td bgcolor="<?php
echo ($_GET['time_option'] == "hw2") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=hw2&time_range=weeks&time_sep[0]=hour&time_sep[1]=between&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $two_week_m; ?>&time[0][3]=<?php echo $two_week_d ?>&time[0][4]=<?php echo $two_week_y ?>&time[1][0]=&time[1][1]=%3C%3D&time[1][2]=<?php echo $today_m ?>&time[1][3]=<?php echo $today_d ?>&time[1][4]=<?php echo $today_y ?>&submit=submit&time[0][9]=AND&time_cnt=2">Last two Weeks</a></td>
			</tr>
		</table>
	</td>
	<td align="center">
...
echo ($_GET['time_option'] == "dw") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=dw&time_range=week&time_sep[0]=day&time_sep[1]=between&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $week_m; ?>&time[0][3]=<?php echo $week_d ?>&time[0][4]=<?php echo $week_y ?>&time[1][0]=&time[1][1]=%3C%3D&time[1][2]=<?php echo $today_m ?>&time[1][3]=<?php echo $today_d ?>&time[1][4]=<?php echo $today_y ?>&submit=submit&time_cnt=1">This Week</a></td>
				<!--<td bgcolor="<?php
echo ($_GET['time_option'] == "dw2") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=dw2&time_range=weeks&time_sep[0]=day&time_sep[1]=between&time[0][0]=<?php echo $two_week_m; ?>&time[0][1]=<?php echo $two_week_d ?>&time[0][2]=<?php echo $two_week_y ?>&time[1][0]=<?php echo $today_m ?>&time[1][1]=<?php echo $today_d ?>&time[1][2]=<?php echo $today_y ?>&submit=submit">Last two Weeks</a></td>-->
				<td bgcolor="<?php
echo ($_GET['time_option'] == "dw2") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=dw2&time_range=weeks&time_sep[0]=day&time_sep[1]=between&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $two_week_m; ?>&time[0][3]=<?php echo $two_week_d ?>&time[0][4]=<?php echo $two_week_y ?>&time[1][0]=&time[1][1]=%3C%3D&time[1][2]=<?php echo $today_m ?>&time[1][3]=<?php echo $today_d ?>&time[1][4]=<?php echo $today_y ?>&submit=submit&time[0][9]=AND&time_cnt=2">Last two Weeks</a></td>
				<!--<td bgcolor="<?php
echo ($_GET['time_option'] == "dm") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=dm&time_range=month&time_sep[0]=day&time_sep[1]=between&time[0][0]=<?php echo $month_m; ?>&time[0][1]=<?php echo $month_d ?>&time[0][2]=<?php echo $month_y ?>&time[1][0]=<?php echo $today_m ?>&time[1][1]=<?php echo $today_d ?>&time[1][2]=<?php echo $today_y ?>&submit=submit">This Month</a></td>-->
				<td bgcolor="<?php
echo ($_GET['time_option'] == "dm") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=dm&time_range=month&time_sep[0]=day&time_sep[1]=between&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $month_m; ?>&time[0][3]=<?php echo $month_d ?>&time[0][4]=<?php echo $month_y ?>&time[1][0]=&time[1][1]=%3C%3D&time[1][2]=<?php echo $today_m ?>&time[1][3]=<?php echo $today_d ?>&time[1][4]=<?php echo $today_y ?>&submit=submit&time_cnt=1">This Month</a></td>
				<!--<td bgcolor="<?php
echo ($_GET['time_option'] == "dm2") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=dm2&time_range=months&time_sep[0]=day&time_sep[1]=between&time[0][0]=<?php echo $two_month_m; ?>&time[0][1]=<?php echo $two_month_d ?>&time[0][2]=<?php echo $two_month_y ?>&time[1][0]=<?php echo $today_m ?>&time[1][1]=<?php echo $today_d ?>&time[1][2]=<?php echo $today_y ?>&submit=submit">Last two Months</a></td>-->
				<td bgcolor="<?php
echo ($_GET['time_option'] == "dm2") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=dm2&time_range=months&time_sep[0]=day&time_sep[1]=between&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $two_month_m; ?>&time[0][3]=<?php echo $two_month_d ?>&time[0][4]=<?php echo $two_month_y ?>&time[1][0]=&time[1][1]=%3C%3D&time[1][2]=<?php echo $today_m ?>&time[1][3]=<?php echo $today_d ?>&time[1][4]=<?php echo $today_y ?>&submit=submit&time[0][9]=AND&time_cnt=2">Last two Months</a></td>
			</tr>
		</table>
	</td>
	<td align="center" valign="top">
		<table cellpadding=5>
			<tr>
				<!--<td bgcolor="<?php
echo ($_GET['time_option'] == "my") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=my&time_range=year&time_sep[0]=month&time_sep[1]=between&time[0][0]=<?php echo $year_m; ?>&time[0][1]=<?php echo $year_d ?>&time[0][2]=<?php echo $year_y ?>&time[1][0]=<?php echo $today_m ?>&time[1][1]=<?php echo $today_d ?>&time[1][2]=<?php echo $today_y ?>&submit=submit">This Year</a></td>-->
				<td bgcolor="<?php
echo ($_GET['time_option'] == "my") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=my&time_range=year&time_sep[0]=month&time_sep[1]=between&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $year_m; ?>&time[0][3]=<?php echo $year_d ?>&time[0][4]=<?php echo $year_y ?>&time[1][0]=&time[1][1]=%3C%3D&time[1][2]=<?php echo $today_m ?>&time[1][3]=<?php echo $today_d ?>&time[1][4]=<?php echo $today_y ?>&submit=submit&time_cnt=1">This Year</a></td>
				<!--<td bgcolor="<?php
echo ($_GET['time_option'] == "mly") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=mly&time_range=year&time_sep[0]=month&time_sep[1]=between&time[0][0]=<?php echo $lyear_m; ?>&time[0][1]=<?php echo $lyear_d ?>&time[0][2]=<?php echo $lyear_y ?>&time[1][0]=<?php echo $today_m ?>&time[1][1]=<?php echo $today_d ?>&time[1][2]=<?php echo $today_y ?>&submit=submit">Last Year</a></td>-->
				<td bgcolor="<?php
echo ($_GET['time_option'] == "mly") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=mly&time_range=year&time_sep[0]=month&time_sep[1]=between&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $lyear_m; ?>&time[0][3]=<?php echo $lyear_d ?>&time[0][4]=<?php echo $lyear_y ?>&time[1][0]=&time[1][1]=%3C%3D&time[1][2]=<?php echo $today_m ?>&time[1][3]=<?php echo $today_d ?>&time[1][4]=<?php echo $today_y ?>&submit=submit&time_cnt=2">Last Year</a></td>
				<!--<td bgcolor="<?php
echo ($_GET['time_option'] == "my2") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=my2&time_range=years&time_sep[0]=month&time_sep[1]=between&time[0][0]=<?php echo $two_year_m; ?>&time[0][1]=<?php echo $two_year_d ?>&time[0][2]=<?php echo $two_year_y ?>&time[1][0]=<?php echo $today_m ?>&time[1][1]=<?php echo $today_d ?>&time[1][2]=<?php echo $today_y ?>&submit=submit">Last two Years</a></td>-->
				<td bgcolor="<?php
echo ($_GET['time_option'] == "my2") ? "#eeeeee" : "#D1D7DF" ?>"><A HREF="base_stat_time.php?time_option=my2&time_range=years&time_sep[0]=month&time_sep[1]=between&time[0][0]=&time[0][1]=%3E%3D&time[0][2]=<?php echo $two_year_m; ?>&time[0][3]=<?php echo $two_year_d ?>&time[0][4]=<?php echo $two_year_y ?>&time[1][0]=&time[1][1]=%3C%3D&time[1][2]=<?php echo $today_m ?>&time[1][3]=<?php echo $today_d ?>&time[1][4]=<?php echo $today_y ?>&submit=submit&time[0][9]=AND&time_cnt=2">Last two Years</a></td>
			</tr>
		</table>
	</td>
</tr>
