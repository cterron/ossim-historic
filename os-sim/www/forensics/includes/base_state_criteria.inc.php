...
class CriteriaState {
    ...
    function ReadState() {
        ...
        */
        ...
        $this->clear_allcriteria = ImportHTTPVar("clear_allcriteria", "", array_keys($this->criteria));
    ...
    function GetClearCriteriaString($name, $element = "") {
        return '&nbsp;&nbsp;<A HREF="' . $this->clear_url . '?clear_criteria=' . $name . '&amp;clear_criteria_element=' . $element . $this->clear_url_params . '">...' . _CLEAR . '...</A>';
    }
    ...
    function ClearAllCriteria() {
        ...
        ErrorMessage(_REMOVE . " <b>All variables</b> " . _FROMCRIT);
    }
}
/* ***********************************************************************
* Function: PopHistory()
