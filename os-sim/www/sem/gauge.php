...
Act on the Cache:
<dl>
<li><a href="javascript:MakeCacheRequest('clean')">Clean</a> (Clean entries older than 1 day)</li>
<li><a href="javascript:MakeCacheRequest('purge')">Purge</a> (Clean everything)</li>
</dl>
</div>
</body>
</html>
