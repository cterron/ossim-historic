...
function load_search_handlers()
{
    ...
    $('#delete_selection').on('click', function()
    {
        ...
        var msg = "<?php echo Util::js_entities(_('Are you sure you want to permanently delete the selected group(s)?')) ?>";
...
function av_group_list(perms)
{
    ...
    this.draw_asset_list = function()
    {
        ...
        __self.datatables_assets = $('.table_data').dataTable(
        {
            ...
            "bServerSide": true,
            "bDeferRender": true,
            "sAjaxSource": __self.cfg.group.providers + "load_groups_result.php",
            "iDisplayLength": 20,
            "bLengthChange": true,
            ...
            oLanguage :
            {
                "sProcessing": "&nbsp;<?php echo _('Loading Groups') ?> <img src='/ossim/pixmaps/loading3.gif' align='absmiddle'/>",
    ...
    this.delete_selection = function()
    {
        ...
        __self.save_selection().done(function()
        {
            ...
            var h_data = 
            {
                "token" : Token.get_token("delete_group_bulk")
            };
        
            $.ajax(
            {
                type: "POST",
                url: __self.cfg.group.controllers  + "bk_delete.php",
                data: h_data,
                dataType: "json",
                beforeSend: function()
                {
                    $('#asset_notif').empty();
                    var _msg = '<?php echo Util::js_entities(_("Deleting Groups... please wait")) ?>';
