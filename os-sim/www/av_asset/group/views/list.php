...
if (!($filter_list instanceof Filter_group_list) || !$back || $cond_filter)
{
    try
    {
        $filter_list = new Filter_group_list($conn);
...
(
    'create'          => TRUE,
    'delete'          => Session::can_i_create_assets(),
...
<head>
    ...
    <?php
        ...
        $_files = array(
            ...
            array('src' => '/av_asset/group/js/list_group.js.php',          'def_path' => FALSE)
        );
    ...
    <script type='text/javascript'>
        ...
        var __asset_list = new av_group_list(<?php echo json_encode($perms) ?>);
        ...
        <div class="content">
            ...
            <div id='content_header'>
                ...
                <div id='asset_section_title'>
                    <?php echo _('Asset Groups') ?>
                </div>
                
                <div id='action_add_buttons'>
                    
                    <a href='javascript:;' id='button_add' data-bind="add-asset" class='button av_b_secondary'>
                        <?php echo _('Create New Group') ?>
                    </a>
