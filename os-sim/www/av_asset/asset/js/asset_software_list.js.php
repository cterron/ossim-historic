...
function Av_software_list(config)
{
    //Public variables
    ...
    this.db = new av_session_db('db_software_' + uniqid());
    ...
    var __msg_container = 'tsw_av_info';

    //Messages to show
    var __messages = {
        "selected_rows"   : "<?php echo _('You have selected ### software.')?>",
        "select_all_rows" : "<?php echo _('Select ### software.')?>",
        'delete_one'      : "<?php echo Util::js_entities(_('Are you sure you want to delete this software?'))?>",
        'delete_selected' : "<?php echo Util::js_entities(_('Are you sure you want to delete the selected software?'))?>",
    ...
    this.draw = function()
    {
        ...
        __self.dt_obj = $('#table_data_software').dataTable(
        {
            "bProcessing": true,
            "bServerSide": true,
    ...
    this.delete_selected_rows = function()
    {
        ...
        av_confirm(__messages.delete_selected, confirm_keys).done(function(){
            ...
            __action_callbacks.delete('software', __selected_rows).done(function(data) {
                ...
                //Reset form
                __action_callbacks.reset('software');
    ...
    this.delete_row = function(row_id)
    {
        ...
        av_confirm(__messages.delete_one, confirm_keys).done(function(){
            ...
            __action_callbacks.delete('software', __selected_row).done(function(data) {
    ...
    {
        var c_all   = $('.rsw_check').length;
        var c_check = $('.rsw_check:checked').length;
    ...
    this.check_all_manual = function()
    {
        ...
        $('.rsw_check').prop('checked', status).trigger('change');
    ...
    this.get_num_selected_rows = function()
    {
        ...
        {
            return $('.rsw_check:checked').length;
        }
    };
    ...
    this.get_selection = function()
    {
        ...
        else
        {
            ...
            $('.rsw_check:checked').each(function(index, elem)
            {
    ...
    function __get_dt_parameters()
    {
        ...
        if (__self.list_type == 'bulk')
        {
            ...
            columns = [
                ...
                {"bSortable": true,  "sClass" : "th_sw_name"},
    ...
    function __create_icon_actions(nRow, aData)
    {
        ...
        $('<img></img>',
        {
            ...
            'click'  : function(e)
            {
                ...
                __action_callbacks.edit('software', r_data);
            }
