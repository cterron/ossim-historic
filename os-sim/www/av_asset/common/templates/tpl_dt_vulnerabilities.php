...
<div data-name="vulnerabilities" data-bind="av_table_vulnerabilities">

	<table class="table_data" id="table_data_vulnerabilities" data-bind="table_data_vulnerabilities">
	    <thead>
	        <tr>
