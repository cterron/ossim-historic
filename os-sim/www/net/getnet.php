...
$xml = "";
$net_list = Net::get_list($conn, "ORDER BY $order $limit");
if ($net_list[0]) {
...
foreach($net_list as $net) {
    ...
    $rep = "";
    if ($linkedocs = Repository::have_linked_documents($conn, $name, 'net')) $rep.= "<a href=\"../repository/repository_list.php?keyname=" . urlencode($name) . "&type=net\" target=\"addcontent\" class=\"blue\">[" . $linkedocs . "]</a>&nbsp;";
